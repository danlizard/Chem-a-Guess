...
def get_cid_by_name(compound_name):
    ...
    # full request template to compare : https://pubchem.ncbi.nlm.nih.gov/rest/pug/<input specification>/<operation specification>/[<output specification>][?<operation_options>]
    pubchem_record_link = "https://pubchem.ncbi.nlm.nih.gov/rest/pug/compound/"
    pubchem_record_link += "name/"+ compound_name +"/record/JSON"
...
def get_first_layer_props(compound_cid, first_layer_props):
    """
    ...
    """
    # THIS HAS BEEN REMOVED DUE TO UNNECESARY CALLS
...
def get_second_layer_props(compound_cid, required_properties):
    """
        1. Accepts the compound name
